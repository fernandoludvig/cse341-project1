 ...
 */
router.post('/', requireAuth, budgetValidation, budgetController.createBudget);
 ...
 *         schema:
 *           type: integer
 *         description: Ano para o resumo - padrao ano atual
 *     responses:
 *       200:
 ...
 *         description: Erro interno do servidor
 */
router.put('/:id', requireAuth, budgetUpdateValidation, budgetController.updateBudget);
